...
def find_lamb(parameters, seed_list, name, cores) :
	...
	start = time.time()
	intervalmin =0.001*parameters["cavity"][0]
	borne = 0.005*parameters["cavity"][0]
	...
	while(test_eq_point):
		...
		patter_N1 = "out_*_c1_" + str(parameters_tmp_1["cavity"][0]) + "_c2_" + str(parameters_tmp_1["cavity"][1]) + ".csv"
		patter_N2 = "out_*_c1_" + str(parameters_tmp_1["cavity"][0]) + "_c2_" + str(parameters_tmp_2["cavity"][1]) + ".csv"
